...
import { differenceInDays, differenceInWeeks, differenceInYears, differenceInMonths } from 'date-fns'
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      <div className="w-full max-w-2xl p-8 bg-white rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold text-center mb-8">Time Since May 9th, 2024</h1>
